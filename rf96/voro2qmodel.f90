subroutine voro2qmodel_orig(voro,npt,npt_max,d_min,d_max,beta,h,vpvs,qa,qb)
...
subroutine voro2qmodel(voro,npt,npt_max,d_min,d_max,beta,h,vpvs)

real voro(npt_max,3),d_min,d_max,beta(npt_max),vpvs(npt_max),maxx,minn,summ,h(npt_max) 
integer npt,ind,i,j,order(npt),npt_max
